...
const translations = {
  en: {
    ...
    nav_notices: "Notices",
    nav_hall: "Hall Hire",
    nav_catechism: "Catechism",
catechism_eyebrow: "Faith Formation",
catechism_h2: "Catechism <em>Classes</em>",
catechism_lead: "Catechism classes run from Grade 1 through to Confirmation (Grade 10). Lessons are taught in English, with the Order of the Mass and key prayers also taught in Portuguese, helping our children stay connected to both their faith and their heritage.",
catechism_day: "Sunday",
catechism_note: "Grade 1 – Confirmation (Gr 10)",
catechism_contact_btn: "Contact the Parish",
    nav_contact: "Contact",
  ...
  pt: {
    ...
    nav_catechism: "Catequese",
catechism_eyebrow: "Formação na Fé",
catechism_h2: "Aulas de <em>Catequese</em>",
catechism_lead: "As aulas de catequese decorrem desde o 1º ano até à Crisma (10º ano). As lições são lecionadas em inglês, sendo também ensinadas a Ordem da Missa e as principais orações em português, ajudando as nossas crianças a manterem-se ligadas à sua fé e herança.",
catechism_day: "Domingo",
catechism_note: "1º ano – Crisma (10º ano)",
catechism_contact_btn: "Contacte a Paróquia",
